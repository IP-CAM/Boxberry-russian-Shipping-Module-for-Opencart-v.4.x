<?php
namespace Boxberry\Logger;

use DateTime;
use Exception;
use RuntimeException;
use Boxberry\Logger\Psr\Log\AbstractLogger;
use Boxberry\Logger\Psr\Log\LogLevel;
...
class Logger extends AbstractLogger
{
     ...
     * @var integer
     */
    protected mixed $logLevelThreshold = LogLevel::DEBUG;
